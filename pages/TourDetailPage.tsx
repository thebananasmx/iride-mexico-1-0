...
const TourDetailPage: React.FC = () => {
    ...
    return (
        <>
                    ...
                    <div className="lg:grid lg:grid-cols-3 lg:gap-12">
                        ...
                        <div className="lg:col-span-1 mt-12 lg:mt-0">
                            <div className="sticky top-28 bg-brand-light p-8 rounded-2xl shadow-lg border border-gray-200">
                                ...
                                <div className="mt-8">
                                    <Button variant="primary" className="w-full text-center" onClick={() => setIsModalOpen(true)}>Book This Tour</Button>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            {isModalOpen && <BookingModal tour={tour} onClose={() => setIsModalOpen(false)} />}
        </>
    );
};
